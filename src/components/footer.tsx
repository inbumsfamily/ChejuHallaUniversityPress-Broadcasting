      ...
      <div class="container mx-auto px-8 py-20">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-16">
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li>
                <a href="/broadcast" class="text-xl text-blue-100 hover:text-white transition-colors duration-300 flex items-center group">
                  <span class="inline-block w-2 h-2 bg-white mr-3 group-hover:w-4 transition-all duration-300"></span>
                  BROADCAST
                </a>
              </li>
              <li>
                <a href="/news" class="text-xl text-blue-100 hover:text-white transition-colors duration-300 flex items-center group">
                  <span class="inline-block w-2 h-2 bg-white mr-3 group-hover:w-4 transition-all duration-300"></span>
                  NEWS
                </a>
              </li>
              <li>
                <a href="/campus" class="text-xl text-blue-100 hover:text-white transition-colors duration-300 flex items-center group">
                  <span class="inline-block w-2 h-2 bg-white mr-3 group-hover:w-4 transition-all duration-300"></span>
                  CAMPUS
                </a>
              </li>
              <li>
                <a href="/culture" class="text-xl text-blue-100 hover:text-white transition-colors duration-300 flex items-center group">
                  <span class="inline-block w-2 h-2 bg-white mr-3 group-hover:w-4 transition-all duration-300"></span>
                  CULTURE
                </a>
              </li>
